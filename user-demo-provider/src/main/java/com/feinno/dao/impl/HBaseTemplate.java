 ...
 */
@Repository
public class HBaseTemplate implements UserDao{
...
//            Cost cost = new Cost();
     ...
     * @param tableName 表名
     */
    public List<User> scanResult(String tableName) {
     ...
     * @return
     */
    public User getResult(String tableName, String rowKey) {
        Result result = null;
        User cost = null;
        try (Connection connection = ConnectionFactory.createConnection(config);
             Table table = connection.getTable(TableName.valueOf(tableName))
...
//        }
//    }
    public static User result2Bean(Result result, String familyName) {
        User cost = new User();
//        获取rowkey的值
